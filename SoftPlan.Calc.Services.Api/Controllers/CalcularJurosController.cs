...
using Softplan.Calc.Services.Api.App.CalcularJuros;
using SoftPlan.Calc.Queries.Juros;

namespace SoftPlan.Calc.Services.Api.Controllers
{
    ...
    public class CalcularJurosController : ControllerBase
    {
        ...
        public async Task<IActionResult> ShowMeTheCode()
            => Ok(new ResultMessageResponse<string>("https://github.com/ArturRibeiro/SoftplanCalcTest"));
    }
}